...
--------------------------------------------------------
  ...
  CREATE TABLE "CITY"."zhifubusiness" 
   (	"ID" NUMBER, 
	...
	"POSTPHONE" VARCHAR2(50 BYTE), 
	"POSTADDR" VARCHAR2(200 BYTE), 
	"CHECK_FILE" NUMBER DEFAULT 0, 
	"CAR_NUM" VARCHAR2(20 BYTE), 
	"TAX_TYPE" VARCHAR2(20 BYTE), 
	"TAX_NUM" VARCHAR2(20 BYTE), 
	"ORIGIN_TYPE" VARCHAR2(20 BYTE), 
	"ORIGIN_NUM" VARCHAR2(20 BYTE)
